...
class UIManager:
    ...
    def create_position_info(self, name: str = 'main', position: tuple = (0.4, -0.4)):
        return self.create_element('dynamic', name,
            text="Position: 0.000, 0.000, 0.000\nRotation: 0.000, 0.000, 0.000",
            position=position, style='status')
    
    def create_instructions(self, name: str, instructions_text: str, position: tuple = (-0.75, 0.45)):
        return self.create_element('static', name,
            text=instructions_text, position=position, style='instructions')
    
    def create_status_indicator(self, name: str, initial_text: str = "", position: tuple = (0, -0.45)):
        return self.create_element('dynamic', name,
            text=initial_text, position=position, style='status', origin=(0, 0))
    
    def create_counter(self, name: str, initial_value: int = 0, position: tuple = (-0.95, 0.4), prefix: str = ""):
    ...
    def create_info_block(self, name: str, title: str, content: str = "", position: tuple = (-0.95, 0.9), is_dynamic: bool = False):
    ...
    def create_debug_info(self, name: str, position: tuple = (0.5, 0.45)):
