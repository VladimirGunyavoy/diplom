...
class SceneSetup:
    def __init__(self, init_position=(1.5, -1, -2), init_rotation_x=21, init_rotation_y=-35, color_manager=None, ui_manager=None, **kwargs):
    ...
    def set_visual_manager(self, visual_manager):
