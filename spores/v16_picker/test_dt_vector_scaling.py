#!/usr/bin/env python3
"""
Тест масштабирования dt-вектора при изменении глобального dt.
"""

import json
import numpy as np

def test_dt_vector_scaling():
    """Тестирует масштабирование dt-вектора при изменении глобального dt."""
    print("🧪 ТЕСТ МАСШТАБИРОВАНИЯ DT-ВЕКТОРА")
    print("=" * 60)
    ...
    # Тестируем масштабирование dt-вектора
    print(f"\n🔧 ТЕСТИРУЕМ МАСШТАБИРОВАНИЕ DT-ВЕКТОРА:")
    ...
    if mock_manual_spore_manager.ghost_tree_dt_vector is not None:
        ...
        if signs_preserved and scale_correct:
            print("✅ Масштабирование работает корректно!")
        else:
