...
H - hide/show all UI"""
    ...
    def show_ui_layout_map(self):
        ...
        print(f"  {UI_POSITIONS.GAME_CONTROLS}  GAME CONTROLS")
        print(f"  {UI_POSITIONS.SPORE_COUNTER}   SPORE COUNTER")
        print(f"  {UI_POSITIONS.SPORE_INSTRUCTION}  F - NEW SPORE")
        print()
        print("ПРАВАЯ СТОРОНА (X > 0):")
        print(f"  {UI_POSITIONS.POSITION_INFO}    POSITION INFO")
        print(f"  {UI_POSITIONS.CURSOR_STATUS}    CURSOR STATUS")
        print(f"  {UI_POSITIONS.LOOK_POINT_DEBUG}    LOOK POINT DEBUG")
        print(f"  {UI_POSITIONS.PARAM_VALUE}  PARAM VALUE")
        print()
        print("ЦЕНТР:")
        print(f"  {UI_POSITIONS.CURSOR_STATUS}      CURSOR STATUS")
        print("=" * 50)
