    ...
    def generate_surface(self, **kwargs):
        ...
        if mesh_model:
            ...
            if kwargs.get('show_contours', False):
                contour_levels = kwargs.get('contour_levels', 8)
                contour_color = kwargs.get('contour_color', None)
                contour_thickness = kwargs.get('contour_thickness', 2)
                contour_resolution = kwargs.get('contour_resolution', 50)
