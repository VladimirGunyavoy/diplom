    ...
    def _get_default_colors(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "spore": {
                ...
                "merged": [0.8, 0.4, 0.8, 1.0]  # Purple for merged spores
            },
            "link": {
                "default": [0.78, 0.78, 0.78, 0.59],
                "ghost_max": [0.9, 0.5, 0.9, 0.7],  # Light purple for max control
                "ghost_min": [0.7, 0.3, 0.7, 0.7],  # Dark purple for min control
                "merged_max": [0.9, 0.5, 0.9, 0.8],  # Light purple for max control merged
                "merged_min": [0.7, 0.3, 0.7, 0.8]   # Dark purple for min control merged
            },
            "ui": {
